...
mem load -i {D:/3rd year 2nd term/Computer Architecture/Project/out.mem} -format binary -filltype value -filldata 0 -fillradix symbolic -skip 0 /cpu/Imem/ram
run
...
mem load -filltype value -filldata 0000000001100100 -fillradix binary /cpu/DM/ram(1)
run
run
run
force -freeze sim:/cpu/interrupt 0 0
